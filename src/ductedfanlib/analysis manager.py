...
def run_bemt_analysis(
    ...
    if op_conditions.axial_velocity_ms == 0.0:
        ...
        results = calculate_bemt_performance_axial(
            rotor_stations_data=rotor_stations,
